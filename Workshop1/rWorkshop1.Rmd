...
```{r echo=FALSE}
knitr::include_graphics("Images/Hitchhikers-Guide-to-the-Galaxy-Diagram-of-Everything-Shirt.jpg")
```
...
When calling a variable, be careful to type it exactly. Try calling the height variable, but spell it incorrectly. You should get an error with something like *Error: object 'hieght' not found*
...
Then do the calculation using the variables. Be sure to add comments on what each line of code is doing like my example above.
