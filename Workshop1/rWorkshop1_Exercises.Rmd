...
**Submit the jupyter notebook on Teams**  

1)  Open the Teams app
2)  Click Teams button on the left side of the app
3)  Open the LSE-DSL-ClassTeams-Demo Team
4)  Select the Python 1 - Numerical Variables channel
5)  Click on View assignment in the Python 1 - Numerical Variables assignment in the Posts tab
6)  Upload your Jupyter notebook