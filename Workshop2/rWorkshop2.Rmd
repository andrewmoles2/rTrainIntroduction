...
```{r eval=FALSE, include=FALSE}
myExpenses <- c(976, 579, 1231, 1120, 1374, 873, 1244, 1398, 989, 1034, 631, 1506)
...
which.max(myExpenses)
which.min(myExpenses)

highLow <- myExpenses[c(which.max(myExpenses), which.min(myExpenses))]
