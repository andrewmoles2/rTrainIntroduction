...
```
## [1] 0.34182578 0.21915825 0.00877457 0.76718112 0.24524362
```
...
```
## [1] -0.2544646  2.0857771 -0.4751139  0.7086322 -0.2242562
```
...
# sample and sort
days_studied <- sort( sample(1:30, 15) )

# generate distributions
uniform <- runif(15, min = 0, max = 60)
normal <- rnorm(15, mean = 30, sd = 15)

# make plots
plot(days_studied, uniform,
     type = "l",
     main = "Days studied and for how long (Uniform distribution)")
```

![](r_fundamentals_2_solutions_files/figure-html/unnamed-chunk-23-1.png)<!-- -->

``` r
plot(days_studied, normal,
     type = "l",
     main = "Days studied and for how long (Normal distribution)")
```

![](r_fundamentals_2_solutions_files/figure-html/unnamed-chunk-23-2.png)<!-- -->
