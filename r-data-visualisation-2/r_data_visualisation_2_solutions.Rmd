...
3) Aggregate your *weekly_vax* data by week and location to find the sum of the `people_vaccinated_per_hundred` column. Assign the result back to *weekly_vax*
...
weekly_vax <- covid %>%
  ...
  summarise(weekly_vax_per_hundred = sum(people_vaccinated_per_hundred, na.rm = TRUE),
            weekly_full_vax_per_hundred = sum(people_fully_vaccinated_per_hundred, na.rm = TRUE),
...
weekly_full_vaccinations  <- weekly_vax %>%
  ...
  labs(title = "Week by week n fully vaccinated people per hundred in 2021",
       subtitle = "United Kingdom, India, Nepal, Israel, Germany, and Australia
       selected for varied vaccine roll outs",
       y = "n people fully vaccinated per hundred",
       colour = "Country") +
...
<https://lse.eu.qualtrics.com/jfe/form/SV_eflc2yj4pcryc62?coursename=R%20Data%20Visualisation%202:%20Box,%20histogram,%20and%20line%20plots&topic=R&link=https://lsecloud.sharepoint.com/sites/TEAM_APD-DSL-Digital-Skills-Trainers/Shared%20Documents/Forms/AllItems.aspx?id=%2Fsites%2FTEAM%5FAPD%2DDSL%2DDigital%2DSkills%2DTrainers%2FShared%20Documents%2FPiloting%20Online%20Data%20Science%20Workshops%2FR%20sessions%2FR%2Ddata%2Dvisualisation%2D2%2Fsolutions&p=true&ct=1635786756925&or=OWA%2DNT&cid=159b01f8%2Dc806%2D0d54%2D8891%2D89ae40ef18b6&prog=DS&version=21-22>
