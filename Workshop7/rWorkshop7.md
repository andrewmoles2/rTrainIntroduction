...
##   <fct>      <fct>  <fct>  <dbl>
## 1 Snorlax    Normal <NA>     540
## 2 Rhyperior  Ground Rock     535
## 3 Lickilicky Normal <NA>     515
```
...
##   name     type_1  type_2  total
##   <fct>    <fct>   <fct>   <dbl>
## 1 Alakazam Psychic <NA>      500
## 2 Starmie  Water   Psychic   520
## 3 Gengar   Ghost   Poison    500
```
...
![](rWorkshop7_files/figure-html/unnamed-chunk-28-1.png)<!-- -->

```r
# plot in a bar plot
barplot(height = table(pokemon_500$type_1),
        col = colour,
        horiz=T, las=1, xlim = c(0, 20),
        xlab = "Frequency", 
        main = "Freqency of Pokemon types\n with total greater than 500")
```

![](rWorkshop7_files/figure-html/unnamed-chunk-28-2.png)<!-- -->
