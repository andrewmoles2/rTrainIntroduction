...
1)  Load in the `janitor` library. Make sure to load `readr` if you don't have it loaded already
2)  Use `read_csv()` to load in the pokemon dataset from this link <"https://raw.githubusercontent.com/andrewmoles2/rTrainIntroduction/master/Workshop4b/data/pokemonGen1.csv">. Cal your data pokemon
