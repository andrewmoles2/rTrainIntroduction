...
# Getting plot with all shapes for vis

```{r}
# all the shapes ggplot can use (maybe save output and use image)
...
# content for functions workshop

Example of how to use a function to find odd numbers and even numbers. 
```{r}
a <- 1:50
