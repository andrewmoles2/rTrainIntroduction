...
thisYear <- data.frame(Appearances = 19,
                       Goals = 10,
                       Season = 2020,
                       Club = 'FC Barcelona',
                       Age = 33,
...
## 15          50    51   2018 FC Barcelona  31              12
## 16          44    31   2019 FC Barcelona  32               3
## 17          19    10   2020 FC Barcelona  33               3
```
...
##  1st Qu.:40.00   1st Qu.:17.00   1st Qu.:2008   Class :character   1st Qu.:21  
##  Median :50.00   Median :41.00   Median :2012   Mode  :character   Median :25  
##  Mean   :44.12   Mean   :37.88   Mean   :2012                      Mean   :25  
...
<https://lse.eu.qualtrics.com/jfe/form/SV_eflc2yj4pcryc62?coursename=R%20Fundamentals%204:%20Data%20Frames%C2%A0&topic=R&link=https://lsecloud.sharepoint.com/:f:/s/TEAM_APD-DSL-Digital-Skills-Trainers/Eq8J0o5HZ2hEhHyfOK_Y8PoBqeKPeb-zo52bUZkCsSUfwg?e=izxDVe&prog=DS&version=21-22>
...
```
## [1] "Dobby the house elf is very Devoted and has a power to evil ratio of 1.5"
```
