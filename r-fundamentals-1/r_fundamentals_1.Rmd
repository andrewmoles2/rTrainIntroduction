...
In the example below, Score1 is 42, Score2 is 92 and so on. If we calculate `Score1 * Score2` what is really happening is `42 * 92`, as this is the data stored in those variables. Run the code, and review the output as well as the variables we have made in the global environment (top right panel in RStudio).
...
3)  Convert your height from cm to feet. Make a new variable called my_height_feet, and assign the calculation of your height in cm to feet. *hint: there are 0.0328084 feet in 1 cm*
...
5)  Assign BankBalance, and calculate BankBalance minus dinner
...
2) Assign the variable of BMI, and calculate the BMI based on the weight and height variables   
3) Print the outcome    
