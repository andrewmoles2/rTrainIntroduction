...
Essentially, the tidyverse makes data science in R less painless, improving your experience of R and data science. 
...
# load data
movies_imdb <- read_csv("data/IMDb movies.csv")
